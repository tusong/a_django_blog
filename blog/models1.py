...
class Blog(models.Model):
	...
	category1=models.ForeignKey(Category1,on_delete=models.CASCADE,verbose_name=u'一级目录')
	category2=models.ForeignKey(Category2,on_delete=models.CASCADE,null=True,verbose_name=u'二级目录')
